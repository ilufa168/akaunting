<x-layouts.auth>
    ...
    <x-slot name="content">
        ...
        <x-form id="auth" route="login" :native="true">
            <div class="grid sm:grid-cols-6 gap-x-8 gap-y-6 my-3.5">
                <x-form.group.email
                    ...
                    input-group-class="input-group-alternative input-min-h-touch"
                    inputmode="email"
                    autocomplete="email"
                />
                ...
                <x-button
                    type="submit"
                    class="relative flex items-center justify-center bg-green hover:bg-green-700 text-white px-6 py-1.5 text-base rounded-lg disabled:bg-green-100 sm:col-span-6 w-full"
                    override="class"
                >
                    {{ trans('auth.login') }}
                </x-button>
