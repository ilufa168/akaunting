...
<div
    data-mobile-actions
    class="absolute min-w-12 min-h-12 w-12 h-12 flex items-center justify-center ltr:right-0 rtl:left-0 -top-3 py-0.5 px-1 bg-white border rounded-full cursor-pointer hover:bg-gray-100"
>
