<x-table>
    <x-table.thead>
        <x-table.tr>
            ...
            @includeWhen(module_is_enabled('outlets'), 'outlets::partials.documents-index-outlet-th')
    ...
    <x-table.tbody>
        @foreach($documents as $item)
            ...
            <x-table.tr href="{{ route($showRoute, $item->id) }}">
                ...
                @includeWhen(module_is_enabled('outlets'), 'outlets::partials.documents-index-outlet-td', ['item' => $item])
