...
<html dir="{{ language()->direction() }}" lang="{{ app()->getLocale() }}">
    ...
    @mobile
    <body class="bg-body safe-area-inset-top safe-area-inset-bottom safe-area-inset-left safe-area-inset-right">
    @elsemobile
    ...
    @endmobile
        ...
        <div class="main-content xl:ltr:ml-[19rem] xl:rtl:mr-[19rem] transition-all ease-in-out" id="panel">
            <div id="main-body">
                <div class="container">
