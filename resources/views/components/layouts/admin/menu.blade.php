...
<div class="container flex items-center py-3 mb-4 border-b-2 xl:hidden safe-area-inset-top">
    <button type="button" class="min-w-12 min-h-12 w-12 h-12 flex items-center justify-center -m-2 cursor-pointer js-hamburger-menu" aria-label="{{ trans('general.menu') }}">
        <span class="material-icons text-black pointer-events-none">menu</span>
    </button>
    ...
    <div class="w-14 py-7 px-1 bg-lilac-900 z-10 menu-scroll overflow-y-auto overflow-x-hidden">
        ...
        <div class="group flex flex-col items-center justify-center menu-toggle-buttons">
            ...
            <x-tooltip id="tooltip-notifications" placement="right" message="{{ trans_choice('general.notifications', 2) }}">
                <button type="button"
                    @class([
                        'flex items-center menu-button justify-center min-w-12 min-h-12 w-12 h-12 mb-2.5 relative cursor-pointer js-menu-toggles outline-none',
            ...
            <x-tooltip id="tooltip-search" placement="right" message="{{ trans('general.search') }}">
                <button type="button" class="flex items-center menu-button justify-center min-w-12 min-h-12 w-12 h-12 mb-2.5 relative cursor-pointer outline-none">
            ...
            <x-tooltip id="tooltip-new" placement="right" message="{{ trans('general.new') }}">
                <button type="button" class="add-item menu-button flex items-center justify-center min-w-12 min-h-12 w-12 h-12 mb-2.5 cursor-pointer js-menu-toggles" data-menu="add-new-menu">
            ...
            <x-tooltip id="tooltip-settings" placement="right" message="{{ trans_choice('general.settings', 2) }}">
                <button type="button" class="settings-item menu-button flex items-center justify-center min-w-12 min-h-12 w-12 h-12 mb-2.5 cursor-pointer js-menu-toggles" data-menu="settings-menu">
            ...
            <x-tooltip id="tooltip-support" placement="right" message="{{ trans('general.help') }}">
                <x-link href="{{ url(trans('header.support_link')) }}" target="_blank" class="flex items-center justify-center min-w-12 min-h-12 w-12 h-12 mb-2.5 cursor-pointer js-menu-toggles" override="class">
