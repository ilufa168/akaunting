    <x-table>
        <x-table.thead>
            <x-table.tr>
                ...
                @includeWhen(module_is_enabled('outlets'), 'outlets::partials.transactions-index-outlet-th')
        ...
        <x-table.tbody>
            @foreach($transactions as $item)
                <x-table.tr href="{{ route('transactions.show', $item->id) }}">
                    ...
                    @includeWhen(module_is_enabled('outlets'), 'outlets::partials.transactions-index-outlet-td', ['item' => $item])
