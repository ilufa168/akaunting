...
class Invoices extends Controller
{
    ...
    public function index()
    {
        ...
        $with = ['contact', 'items', 'items.taxes', 'item_taxes', 'last_history', 'transactions', 'totals', 'histories', 'media'];
        if (module_is_enabled('outlets')) {
            $with[] = 'outlet';
        }
        $invoices = Document::invoice()->with($with)->collect(['document_number'=> 'desc']);
